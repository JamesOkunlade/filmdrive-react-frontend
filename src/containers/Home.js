          ...
          <div className='page home'>
                  ...
                  <div className="imgcarousel ">
                    <div className="single-imgbox w3-card-4">
                      <Link to="/">
                        <img
                          ...
                          src={require("../assets/images/posters/poster1.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div className="single-imgbox w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster7.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div className="single-imgbox  w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster2.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div id="hide" className="single-imgbox   w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster3.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div id="hide" className="single-imgbox w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster4.jpg")} alt=''
                        />
                      </Link>
                    </div>
                  </div>
                  <div className="imgcarousel ">
                    <div className="single-imgbox w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster10.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div className="single-imgbox w3-card-4">
                    ...
                    <div className="single-imgbox  w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster9.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div id="hide" className="single-imgbox   w3-card-4">
                      <Link to="/">
                        <img
                          className="single-img"
                          src={require("../assets/images/posters/poster6.jpg")} alt=''
                        />
                      </Link>
                    </div>
                    <div id="hide" className="single-imgbox w3-card-4">
              ...
              <div className="hmp-section">
                ...
                <div className=" hmp-flexcontainer">
                  ...
                  <div className="hmp-detailcard">
                    ...
                    <h4>
                      Be spoilt for choice. Browse from hundreds of movies.
                    </h4>
                  </div>
                </div>
                <div className=" hmp-flexcontainer">
            ...
            <div className="hmp-footer">
              <h3>
                ...
                stored, Filmdrive can conveniently satiate your movie craze.
                Make your movie list and have them delivered to you every
                Wednesdays and Saturdays. Subscription cost N1000 only. Over 98%
                of our subscribers are pleased with our service.
              </h3>
            </div>
          </div>
        );
